...
b);var c=e.call(this);c.url=encodeURIComponent(a);c.title=encodeURIComponent(n);c.image=d?encodeURIComponent(d.href):"";c.createEvents=c.createEvents.bind(k(c));return c}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url,d=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;a=a.dataset.image?encodeURIComponent(a.dataset.image):this.image;b="https://web.archive.org/web/20220407010449/https://vk.com/share.php?url=".concat(b,"&title=").concat(d,"&image=").concat(a);
return{callback:this.callback,share_url:b,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="vkontakte"]');return this.createEvents(a)}},{key:"getCounter",value:function(){var a=document.createElement("script"),b=document.querySelectorAll('[data-counter="vkontakte"]'),d="https://web.archive.org/web/20220407010449/https://vk.com/share.php?act=count&index=1&url=".concat(this.url);window.VK=Object.assign({},{Share:{}},window.VK);0<b.length&&(window.VK.Share.count=
...
a=a.dataset.image?encodeURIComponent(a.dataset.image):this.image;b="https://web.archive.org/web/20220407010449/https://connect.mail.ru/share?url=".concat(b,"&title=").concat(d,"&description=").concat(c,"&imageurl=").concat(a);return{callback:this.callback,share_url:b,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="moimir"]');return this.createEvents(a)}},{key:"getCounter",value:function(){var a=document.createElement("script"),b=encodeURIComponent(this.url.replace(/^.*?:\/\//,
"")),d=("goodshare_"+Math.random()).replace(".",""),c=document.querySelectorAll('[data-counter="moimir"]');0<c.length&&(window[d]=function(b){p(c).forEach(function(a){a.innerHTML=b.share_mm});null!==a.parentNode&&a.parentNode.removeChild(a)},a.src="https://web.archive.org/web/20220407010449/https://appsmail.ru/share/count/"+b+"?callback="+d,document.body.appendChild(a))}}]);return b}(g),C=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,n=1<arguments.length&&void 0!==arguments[1]?
...
d.title=encodeURIComponent(c);d.createEvents=d.createEvents.bind(k(d));return d}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;b="https://web.archive.org/web/20220407010449/https://buffer.com/add?url=".concat(b,"&text=").concat(a);return{callback:this.callback,share_url:b,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="buffer"]');
return this.createEvents(a)}},{key:"getCounter",value:function(){var a=document.createElement("script"),b=("goodshare_"+Math.random()).replace(".",""),c=document.querySelectorAll('[data-counter="buffer"]'),e="https://web.archive.org/web/20220407010449/https://api.bufferapp.com/1/links/shares.json?url=".concat(this.url,"&callback=").concat(b);0<c.length&&(window[b]=function(b){p(c).forEach(function(a){a.innerHTML=b?b.shares:0});a.parentNode.removeChild(a)},a.src=e,document.body.appendChild(a))}}]);return b}(g),G=function(c){function b(){var a=
0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.title;h(this,b);var d=e.call(this);d.url=encodeURIComponent(a);d.title=encodeURIComponent(c);d.createEvents=d.createEvents.bind(k(d));return d}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;b="https://web.archive.org/web/20220407010449/https://twitter.com/share?url=".concat(b,
...
d?encodeURIComponent(d.content):"";f.createEvents=f.createEvents.bind(k(f));return f}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url,c=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;a=a.dataset.description?encodeURIComponent(a.dataset.description):this.description;b="https://web.archive.org/web/20220407010449/https://www.evernote.com/clip.action?url=".concat(b,"&title=").concat(c,"&body=").concat(a);return{callback:this.callback,share_url:b,windowTitle:"Share this",
...
c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;b="https://web.archive.org/web/20220407010449/https://del.icio.us/save?url=".concat(b,"&title=").concat(a);return{callback:this.callback,share_url:b,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="delicious"]');return this.createEvents(a)}}]);return b}(g),L=function(c){function b(){var a=
0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href,c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.title;h(this,b);var d=e.call(this);d.url=encodeURIComponent(a);d.title=encodeURIComponent(c);d.createEvents=d.createEvents.bind(k(d));return d}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;b="https://web.archive.org/web/20220407010449/https://share.flipboard.com/bookmarklet/popout?ext=sharethis&title=".concat(a,
...
m(b);f(b,[{key:"getPreparedData",value:function(a){a=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a="https://web.archive.org/web/20220407010449/https://mix.com/mixit?su=submit&url=".concat(a);return{callback:this.callback,share_url:a,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="mix"]');return this.createEvents(a)}}]);return b}(g),N=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href;
h(this,b);var c=e.call(this);c.url=encodeURIComponent(a);c.createEvents=c.createEvents.bind(k(c));return c}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){a=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a="https://web.archive.org/web/20220407010449/https://www.meneame.net/submit?url=".concat(a);return{callback:this.callback,share_url:a,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="meneame"]');return this.createEvents(a)}}]);
...
d.createEvents=d.createEvents.bind(k(d));return d}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;b="https://web.archive.org/web/20220407010449/http://www.liveinternet.ru/journal_post.php?action=n_add&cnurl=".concat(b,"&cntitle=").concat(a);return{callback:this.callback,share_url:b,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="liveinternet"]');
...
m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url,c=a.dataset.title?encodeURIComponent(a.dataset.title):this.title;a=a.dataset.description?encodeURIComponent(a.dataset.description):this.description;b="https://web.archive.org/web/20220407010449/https://cang.baidu.com/do/add?iu=".concat(b,"&it=").concat(c,"&dc=").concat(a,"&fr=ien");return{callback:this.callback,share_url:b,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="baidu"]');
...
m(b);f(b,[{key:"getPreparedData",value:function(a){a=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a="https://web.archive.org/web/20220407010449/https://web.skype.com/share?url=".concat(a);return{callback:this.callback,share_url:a,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",value:function(){var a=document.querySelectorAll('[data-social="skype"]');return this.createEvents(a)}}]);return b}(g),ba=function(c){function b(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:document.location.href;
h(this,b);var c=e.call(this);c.url=encodeURIComponent(a);c.createEvents=c.createEvents.bind(k(c));return c}l(b,c);var e=m(b);f(b,[{key:"getPreparedData",value:function(a){var b=a.dataset.url?encodeURIComponent(a.dataset.url):this.url;a=a.dataset.rhash?a.dataset.rhash:null;var c="https://web.archive.org/web/20220407010449/https://t.me/share/url?url=".concat(b);null!==a&&(c="https://web.archive.org/web/20220407010449/https://t.me/iv?url=".concat(b,"&rhash=").concat(a));return{callback:this.callback,share_url:c,windowTitle:"Share this",windowWidth:640,windowHeight:480}}},{key:"shareWindow",
...
/*
     FILE ARCHIVED ON 01:04:49 Apr 07, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:00:42 Sep 04, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 70.642
  LoadShardBlock: 317.347 (3)
  PetaboxLoader3.datanode: 400.392 (5)
  load_resource: 307.227 (2)
  PetaboxLoader3.resolve: 75.665
*/